...
20살 이후의 내 삶은 `다이빙`과 `개발`을 빼놓고 설명할 수가 없다. 나는 20살에 스쿠버 다이빙 동아리를 들어갔다. 그 이후로 지금까지 4년 내내 다이빙을 했다. 동아리 회장까지 맡았을 정도로 다이빙에 진심인 다이버다. 같은 시기, 필수라서 억지로 들었던 파이썬 수업을 계기로 개발을 시작했다. 도저히 흥미가 생기지 않던 본전공 사회학을 버리고 복수전공으로 컴퓨터공학을 선택했다. 그때부터 지금까지 열심히 공부 중인 학생 개발자다.

지금까지 다이빙과 개발은 연관성이 1도 없다고 생각했다. 그런데 점점 다이빙과 개발의 공통점들이 보이기 시작했다. 바로 우테코를 시작하고 나서부터!

## 버디 시스템과 페어 프로그래밍

스쿠버 다이빙의 SCUBA는 **S**elf **C**ontained **U**nderwater **B**reath **A**pparatus Diving의 약자로, 혼자 수중에서 숨 쉴 수 있는 장비를 착용하고 다이빙하는 것을 말한다. 하지만 여기서 한 가지 틀린 말이 있다. 일반적으로 스쿠버 다이빙은 **절대 혼자서 하지 않는다**는 것이다. 
