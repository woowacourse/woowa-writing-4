나는 기억력이 좋지 않다. 누가 “우리 예전에 ~했던 거 기억나?”라고 물어보면, 몇 번을 되물어야 겨우 떠오르는 수준이다. 스스로 이런 점을 알고 있었기에, 나는 이해가 될 때까지 계속 반복해서 찾아보고 공부했다. 지금도 별반 다르지 않다고 생각한다. 하지만 이번 레벨 2를 지나면서 `나만의 학습법 찾기`에 첫 씨앗을 뿌린 것 같아, 그 가닥을 정리해보고자 한다.
