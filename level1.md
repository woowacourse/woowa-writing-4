...
그리곤 메일이 오기로 되어있는 오후 3시 2분 전! 그때부터 길 한가운데에 우두커니 서 메일을 무한 새로고침 하기 시작했다. 3시 1분, 도착한 메일의 느리게 로딩이 되기 시작하였다. 그리고 합격 이미지가 모두 나타났을 때에 드디어 온전히 합격의 기쁨을 느낄 수 있었다. 그날 이후 2월 8일 우아한 테크코스가 시작되는 날까지 고대하는 날들로 채워졌다.
...
우아한 테크코스에서는 각각의 미션에서 랜덤으로 페어를 2~3명 짝을 지어 주어진 기간 동안 같이 미션을 진행한다. 해당 방식으로 미션을 진행하게 되면 좋든 싫든 자연스럽게 상대방의 코드와 자신의 코드가 비교되게 된다. 이건 장점이 될 수도 단점이 될 수 도 있다.
...
하지만 이런 우울감정을 가진 채로 나에게 온 일생에 단 한 번인 소중한 기회인 우아한 테크코스를 보낼 수는 없다. 소크라테스도 말하지 않았는가 <h3>‘너 자신을 알라!’</h3> 라고.

어쩌면 당연한 감정과의 싸움이었다. 나의 경우 프론트 분야를 독학으로 공부하고, 공부기간도 그리 길지 않았기 때문에, 그렇지 않은 크루원들과 실력 차이가 날 수밖에 없다. 또한 홀로 공부하다 보면, 자신이 무엇을 모르고 있는지 알 수 있는 기회를 가지기도 쉽지 않다. 그러니 우아한 테크코스에서의 경험들은 나 자신을 알 수 있는 좋은 도움닫기가 될 수 있다.
...
다른 사람들 보다 잘 하는 것 보다 어제의 나, 저번 주의 나, 한 달 전의 나보다 잘하는 것 을 목표로 두는 것이다.
...
무엇보다 우아한 테크 코스가 끝났을 무렵의 나를 상상하면, 그리 먼 시간이 아닌데도 전혀 상상이 가지 않는다. 마치 저 멀리 하늘에 떠 있는 별을 맨 눈으로 들여다보는 기분이다. 자그맣게 윤곽이 보이긴 하는데 흐릿하게 보이니 이건 뭐, 자세히 보려 할수록 머리만 아프다.
